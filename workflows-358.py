...
async def main():
    ...
    runs = [run_rnaseq_workflow(ops, dataset) for dataset in datasets]
...
def prepare_rnaseq_launch_info(dataset: Dataset) -> LaunchInfo:
    ...
    return LaunchInfo(
        ...
        params={
            ...
            "outdir": f"s3://ntap-add5-project-tower-bucket/outputs/{dataset.run_name}/",
            "gencode": True,
...
async def run_rnaseq_workflow(ops: NextflowTowerOps, dataset: Dataset):
